import { headMetrics } from './metrics/head'
import { bodyMetric } from './metrics/body'
...
<html lang="ru">
  <head>
    ...
    ${process.env.NODE_ENV === 'production' ? headMetrics() : ''}
</head>

<body>
    ${process.env.NODE_ENV === 'production' ? bodyMetric() : ''}
